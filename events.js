...
hoverCard.addEventListener("mouseover", Junction);function Junction() {
...
clickCard.addEventListener("click", function(){clickCard.classList.toggle('revealed'); });
...
document.querySelector("body").style.userSelect="none";doubleClickCard.addEventListener("dblclick", function()
{
